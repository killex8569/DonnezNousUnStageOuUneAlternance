    ...
    <>
      ...
      <section className="accueil-profile-section">
        ...
        <div className="accueil-inline-center">
          ...
          <div className="accueil-profile-item">
            <img src="Alexandre.png" alt="Photo Alexandre FA" className="accueil-img" style={{height: 320}}/>
            <h3>Alexandre F.A</h3>
            <h5 style={{color: "red"}}>n'a pas encore de stage</h5>
            <h5 style={{color: "red"}}>n'a pas encore d'alternance</h5>
          </div>
        ...
        <div className="accueil-feature-card">
          <img src="cpe-lyon.jpg" alt="CPE Lyon" className="accueil-img" style={{maxWidth: 400}}/>
          <div className="accueil-central-info-box">
            ...
            <br/>
            <h5>Nous ne souhaitons pas particulièrement être embauchés ensemble, mais <strong> nous serions ravis si cela pouvait être le cas</strong>. Nous avons déjà l'habitude de travailler sur des projets communs.</h5>
          </div>
          <img src="logo-chartreux.png" alt="Chartreux" className="accueil-img" style={{maxWidth: 400}}/>
        </div>
      </section>
        ...
        <div className="accueil-feature-card">
          <div className="accueil-text-content">
            ...
            <div className="row">
              <div className="accueil-profile-item col">
                    <h4>Valentin</h4>
          ...
          <div className="accueil-placeholder-square accueil-img">photo convaincante</div>
        </div>
